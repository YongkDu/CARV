"""
Logistic regression heatmaps for property pair difficulty analysis (mix task).
...
Usage:
    Configure OUTPUT_DIR, LABEL_DIR, and fig_root in __main__, then run:
        python plot_property_regression.py
"""
import pandas as pd
import numpy as np
import itertools
...
if __name__ == '__main__':
    ...
    model_dict = {}
    for model in ['gemini2.5pro', 'gemini2.5flash', 'gpt5', 'qwen32b']:
        result_dict = {}
    ...
    if model_dict is not None:
        plot_regression_heatmap_4in1_compact(model_dict, f"{fig_root}/heatmap_all_mix_compact.png")
        print(f"\nVisualization saved as 'heatmap_all_mix_compact.png'.")
    else:
